...
function Auth() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      setError("Network error. Check server status. - " + err);
    }
  };

  const inputClasses =
    "w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 bg-white";
    ...
    <div className="grid grid-cols-1 md:grid-cols-12 w-11/12 max-w-6xl mx-auto my-12 bg-white rounded-3xl shadow-2xl overflow-hidden min-h-[70vh]">
      ...
      <div className="hidden md:flex md:col-span-7 bg-indigo-700 items-center justify-center p-12">
        <div className="text-center space-y-6">
          <h1 className="text-5xl font-extrabold text-white">Pro Classroom</h1>
          <p className="text-indigo-200 text-xl font-light">
            The ultimate platform for secure assignment submission and
